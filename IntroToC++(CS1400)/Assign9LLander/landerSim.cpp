...
// did the client type any a's?  If so, return true to engage the autopilot
bool autop(char s[1024]){
	int i=0;
	int a=0;
	while(s[i]!=0){
...
void getCommands(Lander &l){
	...
	if(true){
		...
		// if one of the commands is to engage autopilot, ignore other commands
		if(!autop(commandString)){
...
void printInstructions(){
	...
	cout << "      Enter 'a' to engage autopilot.\n";
